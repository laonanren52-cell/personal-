...
让事情自己排好队。序光（Xuglow）是一个基于 React Native + Expo 的手机端 App Demo，面向学生、比赛、项目、作业、面试等场景，提供 AI 待办提醒、轻重缓急排序、截图识别任务和今日节奏规划。
